<div id="our_services" class="services">
	...
	<div class="services__sides-container">
		<div class="services__left-side">
			<?php if ($background_image): ?>
				<img src="<?php echo esc_url($background_image["url"]); ?>" alt="<?php echo esc_attr($background_image["alt"]); ?>" class="services__image" />
			<?php endif; ?>
		</div>
		...
		<div class="services__right-side">
			<?php if ($service_1): ?>
				<div class="service1"><!-- S1 -->
					...
					<!-- <?php if ($service_1["background_image"]): ?>
						<div class="service1__image-container">
							<img src="<?php echo esc_url($service_1["background_image"]["url"]); ?>" alt="<?php echo esc_attr($service_1["background_image"]["alt"]); ?>" class="service1__image" />
						</div>
					<?php endif; ?> -->
